...
(function (window, document, $) {
  ...
  *************************************************/
    ...
    var ProjectStatsBar4 = new Chartist.Bar('#progress-stats-bar-chart4', {
        labels: ['Mon', 'Tue', 'Wex', 'Thu', 'Fri', 'Sat', 'Sun'],
        series: [
            [20, 17, 14, 18, 15, 20, 18]
        ]
    ...
    ProjectStatsBar4.on('draw', function (data) {
        if (data.type === 'bar') {
            data.element.attr({
                style: 'stroke-width: 25px'
            });
    ...
    var ProjectStatsLine4 = new Chartist.Line('#progress-stats-line-chart4', {
        series: [
            [16, 3, 10, 20, 15, 10]
        ]
    }, lineOptions);

    ProjectStatsLine4.on('created', function (data) {
        var defs = data.svg.querySelector('defs') || data.svg.elem('defs');
        defs.elem('linearGradient', {
            id: 'lineLinearStats4',
            x1: 0,
    ...
    var ProjectStatsBar5 = new Chartist.Bar('#progress-stats-bar-chart5', {
        labels: ['Mon', 'Tue', 'Wex', 'Thu', 'Fri', 'Sat', 'Sun'],
        series: [
            [20, 17, 14, 18, 15, 20, 18]
        ]
    ...
    ProjectStatsBar5.on('draw', function (data) {
        if (data.type === 'bar') {
            data.element.attr({
                style: 'stroke-width: 25px'
            });
    ...
    var ProjectStatsLine5 = new Chartist.Line('#progress-stats-line-chart5', {
        series: [
            [16, 13, 10, 5, 15, 10]
        ]
    }, lineOptions);

    ProjectStatsLine5.on('created', function (data) {
        var defs = data.svg.querySelector('defs') || data.svg.elem('defs');
        defs.elem('linearGradient', {
            id: 'lineLinearStats5',
            x1: 0,
